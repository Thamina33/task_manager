...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    super.initState();
    _emailTEController.text = Get
        .find<AuthController>()
        .user
        ?.email ?? '';
    _firstNameTEController.text = Get
        .find<AuthController>()
        .user
        ?.firstName ?? '';
    _lastNameTEController.text = Get
        .find<AuthController>()
        .user
        ?.lastName ?? '';
    _mobileTEController.text = Get
        .find<AuthController>()
        .user
        ?.mobile ?? '';
  }
  ...
  Future<void> updateProfile() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (response.isSuccess) {
        ...
        Get.find<AuthController>().updateUserInformation(updatedUserModel);
